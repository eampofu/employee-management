...
namespace employee_management.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Name,CreatedById,CreatedOn,ModfiedById,ModifiedOn")] LeaveType leaveType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Name,CreatedById,CreatedOn,ModfiedById,ModifiedOn")] LeaveType leaveType)
        {
            if (id != leaveType.Id)
            {
                return NotFound();
