...
namespace employee_management.Controllers
{
    public class BanksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Name,AccountNo,CreatedById,CreatedOn,ModfiedById,ModifiedOn")] Bank bank)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Name,AccountNo,CreatedById,CreatedOn,ModfiedById,ModifiedOn")] Bank bank)
        {
            if (id != bank.Id)
            {
                return NotFound();
